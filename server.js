...
function convertToImagePrompts(sceneDescriptions, isThumbnail = false, thumbnailData = null) {
  return sceneDescriptions.map((scene, index) => {
    ...
    // SPECIAL THUMBNAIL STYLE: Warhammer 40K-inspired grimdark aesthetic
    if (isThumbnail) {
      return `YouTube documentary thumbnail in grimdark Warhammer-style art: ${basePrompt}. Hand-painted, gritty comic-horror illustration. Close-up of a terrified MechWarrior or technician screaming, wide eyes, tears, sweat, bloodshot eyes, panic, extreme emotional distress. Behind them, a massive BattleMech (Atlas / Marauder / Warhammer) looms in the background, barely visible through smoke, fire, sparks, and industrial ruin. Apocalyptic tone, chaos, destruction, burning metal. Art style: gritty inked comic book, thick linework, distressed textures, vintage halftone dots, worn paper look, heavy grain, propaganda-poster intensity. Color palette: toxic yellows, scorched oranges, blood reds, grim blacks and greens. High-contrast lighting like a horror graphic novel. Small text overlay positioned in LOWER RIGHT CORNER, maximum 2-4 words only, white distressed impact-style font, describing the specific situation from the scene (NOT the video title). Text should be contextually relevant to the story scene, examples based on context: REACTOR CRITICAL, MECH FAILURE, NO SURVIVORS, SYSTEM BREACH, DEAD CREW, LOST SIGNAL, etc. Text positioned at bottom right corner of image. Composition: cinematic, extreme emotion, clear silhouette hierarchy, professional YouTube thumbnail design, 16:9 aspect ratio, ultra sharp, high detail, 4K quality, full film grain texture.`;
    }

    // Regular video frame style: 1950s EC Comics style with HEAVY BattleTech details
    return `1950s EC Comics horror illustration in the BattleTech universe: ${basePrompt}. MUST include BattleMech elements - giant humanoid war machines (Atlas, Marauder, Warhammer, Timber Wolf, Mad Cat, or other BattleMechs), MechWarriors in cooling suits and neurohelmets, or industrial mech bay environments. Sci-fi military aesthetic with massive robotic war machines, fusion reactors glowing, myomer muscle bundles visible, autocannons and PPC weapons, hydraulic pistons, armored plating with battle damage, laser scoring, missile racks. Industrial sci-fi setting: maintenance hangars with gantries and work platforms, mech cockpits with holographic displays, reactor chambers with radiation warnings, ammunition storage, coolant systems, hydraulic repair bays. War-torn environments: destroyed cities, cratered battlefields, burning buildings, mech wreckage, shell casings, smoke and fire. Characters must be MechWarriors (pilot suits, neurohelmets, combat gear) or tech crews (overalls, tool belts, grease-stained). BattleTech technology visible: gyros, actuators, heat sinks, myomer fibers, targeting computers, communication arrays. Grimdark military sci-fi tone, 31st century warfare, Inner Sphere aesthetic. Heavy ink work, vibrant orange lighting from reactor cores and explosions, dramatic shadows, halftone dots pattern, full color comic book style, rich saturated colors with industrial oranges and metallic grays, highly detailed mechanical elements, sharp focus on mech details, professional digital art, 4K quality, cinematic wide-angle composition showing scale of BattleMechs.`;
  });
}
